# Focused on the User, Blind to the Risks: Security and Privacy Understandings, Practices and Challenges of Independent AI Agent Developers
This repository hosts the artifact for our paper, "Focused on the User, Blind to the Risks: Security and Privacy Understandings, Practices and Challenges of Independent AI Agent Developers", detailed information.
...
Note: 
Files under `.github/` are automation scripts for repository maintenance and are not required to reproduce the artifact; reviewers can safely ignore them.
